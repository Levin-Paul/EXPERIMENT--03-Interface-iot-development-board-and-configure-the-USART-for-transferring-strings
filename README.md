...
int main(void)
{
	...
	while (1)
	{
		printf("Levin Paul David\n");
		printf("Reg No : 212224040170");
		HAL_Delay(10000);
	}
}
...
<img width="1920" height="1200" alt="iot exp3" src="https://github.com/user-attachments/assets/d436b4d2-d69f-4de7-9c1b-c5e9030c898e" />
